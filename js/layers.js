...
addLayer("📈", {
    ...
    infoboxes: {
        help: {
	        ...
	        return "<h3>Big text</h3> means that something is dynamic<br><span style=\"color: rgb(255, 255, 255); text-shadow: rgb(255, 255, 255) 0px 0px 10px;\">Colored text with a shadow</span> mean layers/layer points" },
	    },
    },
})
